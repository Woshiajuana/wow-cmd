...
class Generate {
    ...
    start () {
        let AppJson = require(cmdPath, path.join('src/app.json'));
        ...
        fs.writeFileSync('./src/app.json', JSON.stringify(AppJson, null, 4));
        fs.ensureDirSync(`./src/config`);
        fs.writeFileSync(`./src/config/router.config.js`, 'module.exports = ' + JSON.stringify(this.router, null, 4));
        return this;
    }
